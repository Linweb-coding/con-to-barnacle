...
CREATE TABLE `address` (
  ...
  `isDefault` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES ('1', '40000', '广东省广州市黄埔区广州商学院信息工程与技术学院', '1');
INSERT INTO `address` VALUES ('2', '40000', '广东省广州市天河区华南师范大学专家楼3-45', '0');
INSERT INTO `address` VALUES ('3', '40000', '湖北省宜昌市伍家岗区信息咱218号', '0');
...
CREATE TABLE `brand` (
  ...
  `en_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '品牌英文名',
  `intro` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '品牌介绍',
  `logo` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '品牌LOGO',
...
) ENGINE=InnoDB AUTO_INCREMENT=99010 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='品牌表';
...
CREATE TABLE `category` (
  ...
  `isShow` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT '0' COMMENT '是否显示',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `IN_code` (`code`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=20018 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='产品分类表';
...
) ENGINE=InnoDB AUTO_INCREMENT=80006 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='地级市表';
...
CREATE TABLE `company` (
  ...
  `email` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '公司邮箱',
  `chief` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '公司负责人',
  `detail_address` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '公司地址',
...
) ENGINE=InnoDB AUTO_INCREMENT=50003 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='供应商表（公司表）';
...
CREATE TABLE `customer` (
  `id` int NOT NULL AUTO_INCREMENT,
  `realname` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '客户真实名',
  ...
  `imgUrl` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'anno.jpg' COMMENT '客户头像URL',
  `intro` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '客户简介',
  `tel` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT '客户联系电话',
  `email` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '客户邮箱',
  `gender` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '1' COMMENT '客户性别：1男2女',
  `cardID` char(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '客户身份证',
  `regTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '客户注册时间',
  `state` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT '1' COMMENT '客户账号状态：1激活  2锁定 ',
  `level` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT '1' COMMENT '会员等级：1普通会员2钻石会员',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique_username` (`username`) USING BTREE,
  UNIQUE KEY `unique_tel` (`tel`) USING BTREE,
  UNIQUE KEY `unique_email` (`email`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=42706 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='消费者表';

-- ----------------------------
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('40000', 'admin', 'admin', 'admin', 'header.png', '管理员的个人介绍', '15920558888', '235643@qq.com', '0', '23653657', '2021-10-21 09:03:40', '1', '1');
INSERT INTO `customer` VALUES ('40003', '陈生', 'chen', 'chen', 'header.png', '陈老师的个人信息', '15920558666', 'chen@edu.cn', '0', '1111111', '2021-10-21 09:02:27', '0', '2');
INSERT INTO `customer` VALUES ('42705', 'dd', 'dd', 'dd', 'header.png', null, '222', null, '1', null, '2023-04-17 15:51:38', '1', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=90010 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT COMMENT='商品表SKU';
...
) ENGINE=InnoDB AUTO_INCREMENT=100008 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT COMMENT='商品--属性详情表';
...
) ENGINE=InnoDB AUTO_INCREMENT=70046 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='订单详情表';
...
CREATE TABLE `orders` (
  ...
  `payType` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT '1' COMMENT '1支付宝2微信3信用卡4银行卡5到付6现金',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=60039 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='订单表';
...
CREATE TABLE `product` (
  ...
  `intro` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '产品简介',
  `detail` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'anno.jpg' COMMENT '产品详情',
...
) ENGINE=InnoDB AUTO_INCREMENT=50002 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='产品表SPU';
...
) ENGINE=InnoDB AUTO_INCREMENT=20011 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT COMMENT='属性表';
...
CREATE TABLE `propertyitem` (
  ...
  `en_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '英文属性项名称',
...
) ENGINE=InnoDB AUTO_INCREMENT=1060 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='属性详情表';
...
CREATE TABLE `province` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10012 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='省（直辖市）表';
...
) ENGINE=InnoDB AUTO_INCREMENT=90007 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='辖区表';
...
) ENGINE=InnoDB AUTO_INCREMENT=88001 DEFAULT CHARSET=utf8mb3;
